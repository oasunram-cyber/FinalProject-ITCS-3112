...
public class Library {
    ...
    public Library() {
        ...
        loadFromFile();  // Load books automatically when program starts
    }

    public void addBook(String title, String author) {
        collection.add(new Book(title, author));
        Collections.sort(collection); // Alphabetical sorting
        saveToFile();
    ...
    public void listBooks() {
        ...
        Collections.sort(collection); // Sort before displaying
    ...
    private void loadFromFile() {
        ...
        if (!file.exists()) return; // No file yet → start with empty library
